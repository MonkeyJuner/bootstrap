...
// Be carefull about your regular expressions if they are too permissives
var myCustomRegex = ^data-my-app-[\w-]+
myDefaultWhiteList['*'].push(myCustomRegex)
{% endhighlight %}

Maybe you want to bypass our sanitizer because you prefer to use a dedicated library, for example <a href="https://www.npmjs.com/package/dompurify">DOMPurify</a>
