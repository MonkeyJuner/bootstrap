...
<table class="table table-bordered table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>boolean</td>
      <td>true</td>
      <td>Enable or disable the sanitization. If activated <code>'template'</code> and <code>'title'</code> options will be sanitized.
    </tr>
    <tr>
      <td>whiteList</td>
      <td>object</td>
    ...
    <tr>
      ...
      <td>null | function</td>
      <td>null</td>
      <td>You can supply your own sanitize methods, it can be usefull if you prefer to use a special library to sanitize your inputs.</td>
    </tr>
  </tbody>
</table>
